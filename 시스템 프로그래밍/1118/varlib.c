 ...
 * datetime: 2021-11-18 18:17
 * description: a simple storage system to store name=value paris
 ...
 * return 1 if trobule, 0 if ok (like a command)
 */
...
int VLstore(char *name, char *val) {
    ...
    if ((itemp = find_item(name, 1)) != NULL && (s = new_stirng(name, val)) != NULL) {
...
char *new_stirng(char *name, char *val) {
...
/* returns value of var or empty string if not trouble */
