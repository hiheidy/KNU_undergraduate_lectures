 ...
 * datetime: 2021-11-18 20:18
 * description: contains the switch and the functions for builtin commands
 */
 ...
 * details: modifies the string, but restore it to normal
 */
int assign(char *str) {
    char *cp;
    int rv;
